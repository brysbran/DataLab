...
{
    /*
     * in the case of x=3 and y=6
     * first side -  ~x & y is 0100, the ones complement of that is 1011 and then flipped again is still 0100
     * but this wont work unless this number of ~'s is present
     * second side: x(0011) & the ones complement of y(1001), take the ones complement of that (1110)
     */
    return ~(~(~x & y) & ~(x & ~y));
